...
from u2fold.model.train_spec.learning_rate_scheduler.generic import BaseLearningRateSchedulerModel

from torch.optim.lr_scheduler import ReduceLROnPlateau

class ReduceLROnPlateauModel(BaseLearningRateSchedulerModel[ReduceLROnPlateau]):
    ...
    def instantiate(self, optimizer: Optimizer) -> ReduceLROnPlateau:
    ...
    @staticmethod
    def take_step(scheduler: ReduceLROnPlateau, loss: Tensor) -> None:
        scheduler.step(loss)
